...
if __name__ == "__main__":
    ...
    save_file_name = f"./result/{datasetsname}/{args.model}/{args.graph_level_pooling}_{args.node_level_pooling}_pGin{args.pGin}_woNodeatt{args.drop_nb_att}_woGraphatt{args.drop_gb_att}/{start_time_str}/"#.format(datasetsname, args.model,args.graph_level_type)
    ...
    try:
        for k in range(args.k_cross):
            ...
            # ged = train_datasets.ged.to(device)
